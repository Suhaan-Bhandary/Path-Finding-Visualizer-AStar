...
export default class PathfindingVisualizer extends Component {
  ...
  handleMouseDown(row, col) {
    if (this.state.topMessage !== "A* Algorithm") return;
  ...
  //     }
  //   }
  //   this.setState({ topMessage: "aStar Algorithm" });
  ...
  render() {
    ...
    let button_task = (
      <p className="btn" onClick={() => this.visualizeaStar()}>
    ...
    return (
      <div className="pathfindingVisualizer">
        <div className="container">
          ...
          <p>
            A* Algorithm is weighted and guarantees the shortest path and also moves towards the end point as it know the end point!{" "}
